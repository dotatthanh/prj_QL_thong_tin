        ...
        <tbody>
            ...
            @for ($port_origin = 1; $port_origin <= $request->port_origin; $port_origin++)
                ...
                <tr>
                    ...
                    <td>
                        <input style="width: 135px;" type="text" class="form-control" placeholder="Nhập thiết bị" name="device_station[]">
                    </td>
                    <td>
                        <input style="width: 135px;" type="text" class="form-control" placeholder="Nhập toạ độ" name="coordinates_station[]">
                    </td>
                    <td>
                        <input style="width: 135px;" type="number" class="form-control" placeholder="Nhập port" name="port_station[]">
                    </td>
                    <td>
...
<a href="{{ route('tv_streams.index') }}" class="btn btn-secondary waves-effect">Quay lại</a>