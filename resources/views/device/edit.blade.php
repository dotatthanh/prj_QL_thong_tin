...
@section('title') Cập nhật thiết bị @endsection
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0 font-size-18">Cập nhật thiết bị</h4>

                            {{-- <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="{{ route('devices.index') }}" title="Quản lý thiết bị" data-toggle="tooltip" data-placement="top">Quản lý thiết bị</a></li>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ route('devices.update', $data_edit->id) }}" enctype="multipart/form-data">
                                    @method('PUT')
