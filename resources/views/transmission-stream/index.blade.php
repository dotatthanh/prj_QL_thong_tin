                            ...
                            <div class="card-body">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-lg-10">
                                                            ...
                                                            {{-- <td class="text-center">
                                                                <ul class="list-inline font-size-20 contact-links mb-0">
                                                                    ...
                                                                    <li class="list-inline-item px">
                                                                        <a href="{{ route('transmission_streams.edit', $transmission_stream->id) }}" data-toggle="tooltip" data-placement="top" title="Sửa"><i class="mdi mdi-pencil text-success"></i></a>
                                                                    </li>
                                                                    @endcan
                                        ...
                                        @endif
                                        <a href="{{ route('transmission_streams.create') }}" class="d-inline-block text-white btn btn-success btn-rounded waves-effect waves-light mt-2 mb-2"><i class="bx bx-printer mr-1"></i> In file quản lý</a>
                                    </div>
                                </div>
