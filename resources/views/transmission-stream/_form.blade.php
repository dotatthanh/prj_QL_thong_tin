                ...
                <tbody>
                    ...
                    @for ($port_origin = 1; $port_origin <= $request->port_origin; $port_origin++)
                        ...
                        <tr>
                            ...
                            <td>{{ $port_origin }}</td>
                            <td>
                            	<input type="text" class="form-control" placeholder="Nhập nhãn luồng" name="thread_label[]">
                            </td>
                            <td>
                            	<input type="text" class="form-control" placeholder="Nhập dịch vụ" name="service[]">
                            </td>
                            <td>{{ $request->signal_type }}</td>
                            <td>
                            	<input type="text" class="form-control" placeholder="Nhập trạm" name="station[]">
                            </td>
                            <td>
                            	<input type="text" class="form-control" placeholder="Nhập thiết bị" name="device[]">
                            </td>
                            <td>
                            	<input type="text" class="form-control" placeholder="Nhập toạ độ" name="coordinates_remote[]">
                            </td>
                            <td>
                            	<input type="number" class="form-control" placeholder="Nhập port" name="port_remote[]">
                            </td>
                            <td>
