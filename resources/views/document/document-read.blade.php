            ...
            <div class="container-fluid">
                        ...
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Tài liệu đọc</li>
                                </ol>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form method="GET" action="{{ route('document.read') }}">
                                    <div class="row mb-2">
                                        <div class="col-sm-5">
                                                    ...
                                                    <td class="text-center">
                                                        <ul class="list-inline font-size-20 contact-links mb-0">
                                                            ...
                                                            <li class="list-inline-item px">
                                                                <a href="{{ route('documents.edit', $document->id) }}?route=document.read" data-toggle="tooltip" data-placement="top" title="Sửa"><i class="mdi mdi-pencil text-success"></i></a>
                                                            </li>
                                                            {{-- @endcan --}}
