...
class CreateTransmissionStreamsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('transmission_streams', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('transmission_streams');
    }
}
